    ...
    <View
      ...
      <SafeAreaView style={{flex: 1, flexDirection: 'column'}}>
        <View style={[StylesAll.flexWtrapper]}>
          <View style={StylesAll.headWrapper}>
            <TouchableOpacity onPress={() => navigation.goBack()}>
              <View style={[StylesAll.commonHeader, {marginBottom: 10}]}>
                <Image
        ...
        <View style={{paddingHorizontal: 44, paddingVertical: 20}}>
          <Text style={{color: '#000',fontFamily: 'Roboto-Medium',
                                            fontSize : 18,  marginBottom:10}}>Address</Text>

          <Text style={{color: '#000'}}>{route.params?.dataValue.address}</Text>
          <Text  ></Text>
          <Text style={{color: '#000',fontFamily: 'Roboto-Medium',
                                            fontSize : 18, marginBottom:10}}>Phone</Text>

          <Text   style={{color: '#000'}}>{route.params?.dataValue.outletPhone}</Text>
        </View>
