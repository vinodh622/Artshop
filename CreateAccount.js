      ...
      <SafeAreaView style={{flex: 1, flexDirection: 'column'}}>
        ...
        <Formik
          ...
          //  console.log('formmmmmm', form);
            ...
            fetch(
              'http://artshop.shiftlogics.com/api/user/register',
              {
                method: 'POST',
                headers: new Headers({
            ...
            />
                ...
                <View style={{flex: 1}}>
                  ...
                  <TextInput
                    ...
                    placeholderTextColor="#171717"></TextInput>
                  ...
                  <View style={StylesAll.inputFieldBox}>
                    <TextInput
                      defaultValue={'+60'}
                      style={[{flex: 0.15,fontFamily:'Roboto-Medium' ,color:"#171717"}]}
                  ...
                  <TouchableOpacity onPress={showDatePicker}>
                    <View
                      ...
                      <View
                        ...
                        <Text
                          style={[
                            {padding: 5, flex: 1,fontFamily:'Roboto-Medium'},
