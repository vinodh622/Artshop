  ...
  useEffect(() => {
    ...
    const renderItem = ({item,index}) => {
      return (
        ...
        { item.remaining_voucher == '' ||   item.remaining_voucher == 'null' ||  item.remaining_voucher == '0' ?  <View style={{position:"absolute" ,top:0 ,right:0 ,width:"100%" ,height:"100%" ,backgroundColor:"#F9FCFB96" ,marginBottom:20 }}>
          </View> : <View></View>
          }      
        </View>
        </TouchableOpacity>
