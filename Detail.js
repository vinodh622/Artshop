...
const Detail = ({navigation}) => {
  ...
  const logOutAPI = () => {
    ...
    fetch(
      'http://artshop.shiftlogics.com/api/user/logout',
      {
        method: 'POST',
        headers: new Headers({
  ...
  const onPress1 = () => {
    navigation.navigate('WebViewComman', {
      urlString: 'https://www.facebook.com/0.9MartMY/',title : 'FACEBOOK'
    });
  };
  ...
  const onPress3 = () => {
    navigation.navigate('WebViewComman', {
      urlString: 'https://www.instagram.com/0.9mart/?hl=en',title : 'INSTAGRAM'
    });
  };
        ...
        <View style={{flex: 1}}>
          <View style={styles.loginHeaderView}>
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              <Image
                style={[styles.search ,{tintColor:"#ED1C24"}]}
              ...
              <TouchableOpacity
                ...
                <View style={styles.logintextView}>
                  ...
                  <Text
                    style={
                      ([styles.logintext2,
                      {fontFamily: 'Roboto-Medium', fontSize: 12}])
                    }>
...
const styles = StyleSheet.create({
  ...
  list: {
    ...
    marginLeft: 10,
    marginTop: 10,
    marginBottom: 10, tintColor:"#ED1C24"
  },
