 ...
 // console.log('notificationValuesnotificationValues',notificationValues);
  ...
  useEffect(() => {
    ...
    GoogleSignin.configure({
      webClientId:
        '310107947550-d7acqa3m2hvn4a4rg8lu7d3d2cfnue9c.apps.googleusercontent.com',
    });
  }, []);
            ...
            {errorCheck ? (
              <View style={StylesAll.errorSnackbar}>
                ...
                <View style={{flexDirection: 'column', paddingLeft: 13}}>
                  <Text style={StylesAll.whitecolor}>The Art Shop Weststar</Text>
...
<View style={{flexDirection:"row" ,marginBottom:17  ,justifyContent:"flex-start"}}>
<Image
            ...
            <Formik
              ...
              onSubmit={async (values) => {
                ...
                fetch(
                  'http://artshop.shiftlogics.com/api/user/loginphone',
                  {
                    method: 'POST',
                    headers: new Headers({
              ...
              {(props) => (
                <View>
                  <View style={StylesAll.inputFieldBox}>
                    ...
                    <TextInput
                      style={[StylesAll.inputwrap2,{fontFamily:'Roboto-Medium'}]}
            ...
            <TouchableOpacity
              ...
              <Text style={[StylesAll.mediamFont, {textAlign: 'center',color:'#171717'}]}>
                Continue as guest
              </Text>
            </TouchableOpacity>
            <View style={StylesAll.ltguestWrapper}>
                  ...
                  <TouchableOpacity onPress={_signIn}>
                    <View style={StylesAll.googleButton}>
                      <Image
                        ...
                        resizeMode="contain"
                      />
                      <Text style={[{fontSize: 12,color:'#717171',fontFamily:'Roboto-Medium'}]}>Sign in with Google</Text>
                    </View>
                  </TouchableOpacity>
                </View>
              </View>
              ...
              <TouchableOpacity onPress={onPress2}>
                <Text style={{textAlign: 'center',color:'#171717',fontFamily:'Roboto-Medium'}}>Register with email</Text>
              </TouchableOpacity>
            </View>
          </View>
        </SafeAreaView>
