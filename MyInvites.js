...
const MyInvites = ({navigation}) => {
    ...
    if (loginData === null) {
      ...
      return (
        <View style={{flex:1,justifyContent:'center',alignItems:'center',marginTop: 50}}>
          ...
          <Text style={[{marginTop: 5,color:COLORS.black}, StylesAll.boldFontLight2]}>
  ...
  useEffect(() => {
    ...
    fetch(
      'http://artshop.shiftlogics.com/api/user/referrallist',
      {
        method: 'POST',
        headers: new Headers({
  ...
  const renderItem = ({ item }) => {
    ...
    return(
            ...
            <View style={{flexDirection: 'column',alignItems: 'center',backgroundColor:'#F9FCFB'}}>
              <View style={{paddingHorizontal: 40 ,marginBottom:14}}>
            <Image source={require('./Image/Referfriend.png')} 
              style= {{width: '100%',height: undefined  ,aspectRatio: 800 / 540,}} resizeMode= 'contain'
             >
            ...
            <Text style={[{color: COLORS.app_browntheme,paddingLeft: 20,paddingRight: 10, fontFamily: 'Roboto-Medium',
  fontSize : 17,}]}>SHARE</Text>
            ...
            <View style={{backgroundColor: '#F9FCFB',flex:1,flexDirection: 'column',padding:20}}>
             <Text style={[{color: '#fff',margin: 0,paddingBottom:15, fontFamily: 'Roboto-Medium',
  fontSize : 17,}]}>My invites</Text>
             ...
             <Text style={{color: '#fff'}}>Invite contacts</Text>
