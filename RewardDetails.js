...
const RewardDetails = ({navigation, route}) => {
  ...
  useEffect(() => {
    ...
    fetch('http://artshop.shiftlogics.com/api/redeem/checkRedeem', {
      method: 'POST',
      headers: new Headers({
  ...
  const setreddem = () => {
    ...
    fetch('http://artshop.shiftlogics.com/api/redeem/addRedeem', {
      method: 'POST',
      headers: new Headers({
        Accept: 'application/json',
        'Content-Type': 'multipart/form-data',
  ...
  return (
    <View style={[StylesAll.flexWtrapper, {backgroundColor: '#F9FCFB'}]}>
      <StatusBar barStyle="dark-content" backgroundColor="#F9FCFB"></StatusBar>
      <SafeAreaView style={{flex: 1, flexDirection: 'column'}}>
        <View style={[StylesAll.headWrapper, {paddingBottom: 10}]}>
        ...
        <View
          ...
          <ImageBackground
            source={{
              uri: `http://artshop.shiftlogics.com/${route.params?.dataValue.photo}`,
            }}
            style={[
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              <View
                ...
                <Image
                  ...
                  style={{width: 25, height: 20 ,tintColor:"#ED1C24"}  }
                  resizeMode="contain"
                />
              ...
              {route.params?.dataValue.sub_title  ===  null ? null :<Text style={[StylesAll.commom_color, {paddingTop: 13  ,paddingBottom:1,}]}>
           {route.params?.dataValue.sub_title}
           </Text>}
...
listsPrefixesRenderers={{
 ...
 source={
   ...
   {html: route.params?.dataValue.description}}
          ...
          <View style={[StylesAll.common_Modal, {justifyContent: 'flex-end'}]}>
            <View style={[StylesAll.modalBox]}>
              <View style={{flexDirection: 'row', justifyContent: 'center'}}>
                <Image source={require('./Image/icons8-clock.png')} style={{tintColor:"#ED1C24"}} />
              </View>
              <Text></Text>
              ...
              <View
                ...
                <View
                  ...
                  <View
                    ...
                    <Image
                      style={{width: 20, height: 20 ,tintColor:"#ED1C24"}}
                ...
                {/* <View style={{}}>
                  <ProgressBar progress={1} color={'#ED1C24'} />
                </View> */}
              </View>
            </View>
          </TouchableOpacity>
