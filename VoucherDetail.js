...
export default function VoucherDetail({navigation, route}) {
  ...
  const addFavourite = (id) => {
    ...
    fetch('http://artshop.shiftlogics.com/api/favourite/addFavourite', {
      method: 'POST',
      headers: new Headers({
        ...
        <View style={StylesAll.innerWrapper}>
          <View style={[StylesAll.flexWtrapper, {}]}>
            <ScrollView showsVerticalScrollIndicator={false}>
              ...
              {route.params?.dataValue.link  ===  null ? null :<Text style={[StylesAll.commom_color, {paddingTop: 13  ,paddingBottom:1,}]}>
            ...
            <View style={StylesAll.modalBox}>
              ...
              <View
                ...
                <Image
                  ...
                  style={[{width: 270, height: 190} ,{tintColor:"#FDC20F"}]}
                  resizeMode="cover"
                />
              </View>

              <View style={{marginTop: 40}}>
                <Text style={[StylesAll.lightFont,{color:'#171717'}]}>
          ...
          <View style={[StylesAll.common_Modal, {justifyContent: 'center'}]}>
            <View style={StylesAll.modalBox}>
              ...
              <View style={{marginTop: 5,marginBottom:5,justifyContent:'center',alignItems:'center'}}>
                <Text style={[StylesAll.boldFont,{color:"#171717",textAlign:'center'}]}>
