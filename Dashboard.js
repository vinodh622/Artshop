...
const Dashboard = ({navigation}) => {
  ...
  //       fetch(
  //         'http://artshop.shiftlogics.com/api/favourite/viewFavourite',
  //         {
  //           method: 'POST',
  //           headers: new Headers({
  //             Accept: 'application/json',
  ...
  const LoginEmpty = () => {
    return (
      ...
      <View style={{flex:1 ,backgroundColor:"#F9FCFB"}}>  
 <TouchableOpacity onPress={() => navigation.navigate('Detail')}>
        <View style={StylesAll.alertMsg}>
          ...
          />
          <Text style={[{marginVertical: 10}, StylesAll.emptyDatatext]}>
            Oops, login is required!
          </Text>
          <Text style={StylesAll.emptyDatatext}>You need to login to access this feature</Text>
        </View>
      </TouchableOpacity>
      ...
      {loginData === null ? (
        ...
        <SafeAreaView
          ...
          <View style={StylesAll.headWrapper}>
            ...
            <Text style={{paddingVertical:5,  fontFamily: 'SFCompactDisplay-Light', color:"#171717",
                ...
                <TouchableOpacity style={{flex:1}}
                  ...
                  <View style={StylesAll.listButton}>
                    <Image
                      ...
                      style={[StylesAll.btnIcons ,{tintColor:"#EFAF13"}]}
                    />
...
<Image source={require('./Image/order.png')} style={{tintColor:"#ED1C24"}} />
                ...
                {favourite.length == 0 ? null : (
                  <Text
                    style={[
                      ...
                      {paddingTop: 20, paddingBottom: 15,fontFamily:'Montserrat-Bold',fontSize:20,
                    color:"#171717"},
                    ]}>
                    Voucher
                  </Text>
